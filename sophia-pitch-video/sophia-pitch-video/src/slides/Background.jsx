...
export const Background = ({ startFrame = 0 }) => {
      ...
      <div style={{ display: "flex", flex: 1, gap: 0 }}>
        ...
        <div style={{ flex: 1, padding: "40px 50px", borderRight: `3px solid ${COLORS.blue}20` }}>
          <div style={{
            ...
            marginBottom: 28, opacity: fadeIn(f, 10, 20),
          ...
          {stats.map((s, i) => (
            <div key={s.label} style={{
              display: "flex", alignItems: "center", gap: 20,
              marginBottom: 24,
              transform: `translateY(${slideUp(fps, f, 0, i * 8)}px)`,
              opacity: fadeIn(f, 15 + i * 8, 20),
              background: COLORS.white,
              borderRadius: 12,
              padding: "18px 24px",
              boxShadow: "0 2px 12px rgba(0,0,51,0.08)",
        ...
        <div style={{ flex: 1.2, padding: "40px 50px" }}>
          ...
          {advantages.map((a, i) => (
            <div key={a.title} style={{
              marginBottom: 28,
              transform: `translateY(${slideUp(fps, f, 0, 20 + i * 10)}px)`,
              opacity: fadeIn(f, 20 + i * 10, 20),
              background: COLORS.white,
              borderRadius: 16,
              padding: "24px 28px",
              boxShadow: "0 2px 16px rgba(0,0,51,0.08)",
